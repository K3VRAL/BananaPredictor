...
$(TARGET): main.o src/run.o src/objects.o src/lib/print.o src/lib/files.o src/lib/fastrandom.o
...
cleanx:
	rm $(BINFLR)$(TARGET)$(EXEC)

add7z:
	7z a $(BINFLR)$(ENV)_codesu_$(VER).7z $(BINFLR)$(TARGET)$(EXEC)
