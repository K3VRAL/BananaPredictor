...
{
    // REMOVE THIS FILE WHEN GETTING OTHER WORKING; VERY WEIRD PROGRAMMING DESCISIONS
    public class BananaPredictorOld
    {
        ...
        public bool SpinnerPredictorOld(string path)
        {
            // Read file
